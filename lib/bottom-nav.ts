 ...
 * throughout Qari and Prayer. The mushaf still hides it to keep the whole
 * screen for reading, and the Qari record screen hides it too — that's a
 * single task with its own way out.
 */

/** The bar's own height, in rem — not counting the phone's safe area below it. */
export const BOTTOM_NAV_HEIGHT_REM = 4.25

/** Exact pathnames the bar appears on, beyond the whole Qari and Prayer sections. */
