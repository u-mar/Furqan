...
const SETTINGS: Dict = {
  ...
  'Page navigation': { so: 'Sida bogagga loo dhaqaajiyo', ar: 'التنقل بين الصفحات' },
  'How you move between pages in Read.': { so: 'Sida aad bogagga ugu dhex dhaqaaqdo Akhriska.', ar: 'كيف تنتقل بين الصفحات في القراءة.' },
  'Horizontal swipe': { so: 'Dhaqaajin dhinac ah', ar: 'السحب الأفقي' },
  'Swipe left and right, like turning pages': { so: 'Dhaqaaji bidix iyo midig, sida bog rogid', ar: 'اسحب يمينًا ويسارًا، كتقليب الصفحات' },
  'Vertical swipe': { so: 'Dhaqaajin toosan', ar: 'السحب العمودي' },
  'Swipe up and down, one page at a time': { so: 'Dhaqaaji kor iyo hoos, bog kasta gaar ahaan', ar: 'اسحب لأعلى ولأسفل، صفحة تلو الأخرى' },
  'Continuous scroll': { so: 'Duulitaan joogto ah', ar: 'التمرير المتواصل' },
  'Scroll smoothly, with no page-turn': { so: 'Ku duul si siman, iyada oo aan bog la rogin', ar: 'مرّر بسلاسة، دون تقليب صفحات' },
