...
export default function PromoBanner({ className }: { className?: string }) {
  ...
  const ctaInner = (
    <span className="shrink-0 rounded-xl bg-amber-400 px-4 py-2.5 text-sm font-bold text-black shadow-md transition-transform hover:scale-[1.02] active:scale-[0.98]">
      {slide.cta}
    </span>
  )
  ...
  return (
    <section className={cn('mb-5 lg:mb-0 lg:flex lg:flex-col', className)}>
      <div className="relative flex-1 overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-emerald-800 via-emerald-600 to-amber-600 px-4 py-4 shadow-lg lg:min-h-[140px] lg:px-6 lg:py-6">
        <div
